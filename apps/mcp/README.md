...
1. `list_scene_types` and expect the 13 scene-types (hook, title-cards, flow, fanout, metric, bars, big-stat, comparison, timeline, quote, code, social-card, outro) with slot summaries.
