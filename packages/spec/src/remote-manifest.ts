...
export const Sha256Hex = Schema.String.pipe(Schema.pattern(/^[a-f0-9]{64}$/)).annotations({
...
export const decodeRemoteManifest = Schema.decodeUnknownEither(RemoteManifest, { errors: "all" });
