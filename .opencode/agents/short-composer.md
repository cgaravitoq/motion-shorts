...
Self-framed scene-types (code, social-card, code-output, annotated-asset, before-after) already provide their own container — never double-frame them.
